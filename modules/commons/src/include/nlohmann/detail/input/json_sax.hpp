...
template <typename BasicJsonType> struct json_sax
{
    ...
    */
    virtual bool
    number_float(number_float_t val, const string_t& s)
        = 0;
    ...
    */
    virtual bool
    start_object(std::size_t elements)
        = 0;
    ...
    */
    virtual bool
    start_array(std::size_t elements)
        = 0;
    ...
    */
    ...
    json_sax&
    operator=(const json_sax&)
        = default;
    json_sax&
    operator=(json_sax&&) noexcept
        = default;
...
public:
    ...
    */
    ...
    json_sax_dom_parser&
    operator=(const json_sax_dom_parser&)
        = delete;
    json_sax_dom_parser&
...
public:
    ...
    json_sax_dom_callback_parser(json_sax_dom_callback_parser&&)
        = default; // NOLINT(hicpp-noexcept-move,performance-noexcept-move-constructor)
    json_sax_dom_callback_parser&
    operator=(const json_sax_dom_callback_parser&)
        = delete;
    json_sax_dom_callback_parser&
